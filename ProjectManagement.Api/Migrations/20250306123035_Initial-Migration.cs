    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Companies",
                columns: new[] { "Id", "CompanyCode", "CompanyName", "CreatedAt", "IsDeleted", "Location", "UpdatedAt" },
                values: new object[,]
                {
                    { 1, "WISESTONET", "WISESTONE T", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 0, "South Korea", null },
                    { 2, "WISESTONEU", "WISESTONE U", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 0, "Uzbekistan", null },
                    { 3, "WISESTONE", "WISESTONE", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 0, "South Korea", null }
                });

            migrationBuilder.InsertData(
                table: "Teams",
                columns: new[] { "Id", "AssignedCompanyId", "CreatedAt", "IsDeleted", "Location", "UpdatedAt" },
                values: new object[] { 1, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 0, "UZB", null });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CompanyId", "CreatedAt", "Email", "IsDeleted", "Name", "Password", "PhoneNumber", "Surname", "TeamMemberId", "UpdatedAt" },
                values: new object[] { 1, 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@gmail.com", 0, "Admin", "web123$", "998881422030", "System", 1, null });

            migrationBuilder.InsertData(
                table: "TeamMembers",
                columns: new[] { "TeamId", "UserId", "CreatedAt", "Id", "IsCurrent", "IsDeleted", "Role", "UpdatedAt" },
                values: new object[] { 1, 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, true, 0, 4, null });
