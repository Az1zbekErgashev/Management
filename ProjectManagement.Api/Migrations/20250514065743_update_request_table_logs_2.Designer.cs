...
namespace ProjectManagement.Api.Migrations
{
    ...
    [Migration("20250514065743_update_request_table_logs_2")]
    partial class update_request_table_logs_2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectManagement.Domain.Entities.Country.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ProjectManagement.Domain.Entities.Requests.Comments", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ProjectManagement.Domain.Entities.Requests.ProcessingStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ProjectManagement.Domain.Entities.Requests.RequestHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ProjectManagement.Domain.Entities.User.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CountryId = 1,
                            CreatedAt = new DateTime(2025, 5, 14, 6, 57, 42, 895, DateTimeKind.Utc).AddTicks(7067),
            ...
            modelBuilder.Entity("ProjectManagement.Domain.Entities.Requests.Comments", b =>
                {
                    b.HasOne("ProjectManagement.Domain.Entities.Requests.Comments", "ParentComment")
                        .WithMany("Replies")
                        .HasForeignKey("ParentCommentId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("ProjectManagement.Domain.Entities.Requests.Request", "Request")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("ProjectManagement.Domain.Entities.Requests.Request", b =>
                {
                    b.HasOne("ProjectManagement.Domain.Entities.Attachment.Attachment", "File")
                        .WithMany()
                        .HasForeignKey("FileId");

                    b.HasOne("ProjectManagement.Domain.Entities.Requests.ProcessingStatus", "ProcessingStatus")
                        .WithMany()
