...
namespace ProjectManagement.Api.Migrations
{
    ...
    [Migration("20250307123459_UPDATE_USER_TABLE_ADDED_IMAGE")]
    partial class UPDATE_USER_TABLE_ADDED_IMAGE
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProjectManagement.Domain.Entities.Companies.Companies", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 3, 7, 12, 34, 59, 131, DateTimeKind.Utc).AddTicks(8273),
                            IsDeleted = 0,
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 3, 7, 12, 34, 59, 131, DateTimeKind.Utc).AddTicks(8275),
                            IsDeleted = 0,
                            Location = "Uzbekistan"
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 3, 7, 12, 34, 59, 131, DateTimeKind.Utc).AddTicks(8276),
                            IsDeleted = 0,
                            Location = "South Korea"
                        });
                });
            ...
            modelBuilder.Entity("ProjectManagement.Domain.Entities.User.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompanyId = 1,
                            CountryId = 1,
                            CreatedAt = new DateTime(2025, 3, 7, 12, 34, 59, 131, DateTimeKind.Utc).AddTicks(8386),
            ...
            modelBuilder.Entity("ProjectManagement.Domain.Entities.Teams.Team", b =>
                {
                    ...
                    b.HasOne("ProjectManagement.Domain.Entities.Companies.Companies", null)
                        .WithMany("Teams")
                        .HasForeignKey("CompaniesId");
